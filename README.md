...
Etichetare imagini: labelImg
Antrenare model: Ultralytics YOLOv8
...
Organizarea datasetului pentru antrenare

Imaginile și fișierele de etichete sunt copiate în structura YOLOv8:

tools/yolov8/data/ ├── images/ │ ├── train/ │ └── val/ └── labels/ ├── train/ └── val/
...
Integrarea în proiectul principal
